  ...
  return (
    <ThemeWrapper>
      <div className="flex items-center justify-center  px-4 sm:px-6">
        <div className="w-full max-w-md p-6 sm:p-8 mt-5  ">
          {/* Header Section */}
          <CardHeader className="text-center">
            <h1 className="text-xl font-bold tracking-tight">SQUAD SYNC</h1>
            <h1 className="text-2xl sm:text-3xl mt-2 sm:mt-3 font-semiboldleading-tight">
              {title}
            </h1>
            <p className="text-xs sm:text-sm my-2 sm:mt-3  leading-relaxed">
              {subtitle}
            </p>
            <Button
              variant="outline"
          ...
          <CardContent className="space-y-4 sm:space-y-5">
            ...
            <div className="relative flex items-center justify-center my-5">
              ...
              <span className="absolute  dark:bg-gray-800 px-2 sm:px-3 text-xs sm:text-sm  font-medium">
                OR
              </span>
            </div>
