...
const ChatWindow = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-60px)] rounded-br-lg rounded-tr-lg shadow-lg ">
      {/* Chat Header */}
      ...
      <div className="p-4 border-t dark:border-gray-700 flex items-center gap-3 ">
        <Input
          ...
          className="flex-1 rounded-full border border-gray-300 dark:border-gray-700 focus:ring-2 focus:ring-blue-500"
        />
        <Button
          disabled={!newMessage}
